...
public class WriteEncryptedData 
{
    public static void main(String[] args) 
    {
        try 
        {
            ...
            String jsonString = FileReadWrite.readFromFile( dir + "patient_medical_records.json");
            ...
            FileReadWrite.writeToFile( dir + "encryptedData.txt", encryptedData);

            String privateKey = rsa.getPrivateKey();
            FileReadWrite.writeToFile( dir + "privateKey.txt", privateKey);
